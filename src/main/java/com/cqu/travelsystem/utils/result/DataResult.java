package com.cqu.travelsystem.utils.result;
...
import com.cqu.travelsystem.utils.result.code.Errs;
...
public class DataResult<E> implements Code {
	...
	public static DataResult<JSONObject> successByData(Object data) {
		String jsonString = JSONObject.toJSONStringWithDateFormat(data, "yyyy-MM-dd", SerializerFeature.DisableCircularReferenceDetect);
